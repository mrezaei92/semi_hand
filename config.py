...
def get_args_parser():
    ...
    parser.add_argument('--comjitter',default=1, type=int, help="wether to do add random noise to COM")
    ...
    parser.add_argument('--nesterov', default=0, type=int, help="wether to use nesterov for SGD optimizer")


    # Scheduler

    parser.add_argument('--scheduler',type=str,default="cosine", choices=('steplr', 'cosine','cosineWarmap'), help="The choice for scheduler")
    ...
    parser.add_argument('--unlabeled_weight_start', default=1e-1, type=float, help="the initial weight of the unlabled loss")
    parser.add_argument('--unlabeled_weight_end', default=8e-1, type=float, help="the final weight of the unlabled loss")
    parser.add_argument('--TSA',default="exp", choices=('exp', 'linear','cosine','log'),type=str,help="The type of Signal Annealing")
